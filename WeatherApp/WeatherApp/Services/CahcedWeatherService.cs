...
{
	internal class CahcedWeatherService : IWeatherService
	{
		private readonly IAggreagatedWeatherService aggreagatedWeatherService;
		private readonly ILogger<CahcedWeatherService> logger;
		...
		public CahcedWeatherService(
				IAggreagatedWeatherService aggreagatedWeatherService,
				ILogger<CahcedWeatherService> logger)
		{
